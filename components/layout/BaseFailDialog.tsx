...
export default function BaseFailDialog({
  open = true,
  title = "ERROR",
  message,
  onClose,
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <p className="text-sm font-bold tracking-wide text-rose-400">{title}</p>
